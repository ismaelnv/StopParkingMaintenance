...
import { getPromotionId, updatePromotion } from '@/service/PromotionsService';
...
export function PromotionsUpdateDialog({id, onUpdate}: UserDialogProps) {
    ...
    useEffect(() =>{
      const getPromotion = async () =>{
        const promotion =  await getPromotionId(id)
        if(promotion){
          setPromotionCode(promotion.codigoPromocion)
          setDiscount(String(promotion.descuento))
          setDescription(promotion.descripcion)
          setEndDate(String(promotion.fechaFin))
          setStartDate(String(promotion.fechaInicio))
        }
